      ...
      <section className="mx-auto max-w-6xl px-6 py-14 sm:py-24">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <ModuleCard
            ...
            title="Тексты"
            subtitle="Les textes"
            description="Écris en français ou colle un texte russe : chaque mot décliné dit son cas. Touche-le, tu sais pourquoi il est à ce cas — et tu t'entraînes à les deviner."
          />
        </div>
      </section>
